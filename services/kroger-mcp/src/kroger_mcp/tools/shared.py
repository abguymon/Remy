...
DATA_DIR = "data"
PREFERENCES_FILE = f"{DATA_DIR}/kroger_preferences.json"
...
def get_authenticated_client() -> KrogerAPI:
    ...
    try:
        ...
        # Try to load existing user token first (use data/ directory for persistence)
        ...
        if token_info:
            ...
            if "refresh_token" in token_info:
                try:
                    ...
                    if new_token_info:
                        _save_token(token_file, new_token_info)
