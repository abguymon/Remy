"""Authentication router - login and register"""

from fastapi import APIRouter, Depends, HTTPException, status
from sqlalchemy import select
from sqlalchemy.ext.asyncio import AsyncSession

from remy_api.auth import create_access_token, hash_password, verify_password
from remy_api.config import get_settings
from remy_api.database import InviteCode, User, UserSettings, get_db
from remy_api.models import Token, UserLogin, UserRegister, UserResponse
